...
export default function DanubeParkFooter() {
  const t = useTranslations('danubePark.footer');
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start gap-8 mb-8">
          <div className="max-w-md">
            ...
            <div className="flex flex-col gap-2">
              <a href="https://www.nscentar.rs/" target="_blank" rel="noopener noreferrer" className="hover:underline text-sm" style={{ color: 'var(--accent)' }}>
                {t('officialLinks.tourism')}
              </a>
              <a href="https://www.muzejns.rs/" target="_blank" rel="noopener noreferrer" className="hover:underline text-sm" style={{ color: 'var(--accent)' }}>
                {t('officialLinks.museums')}
              </a>
              <a href="https://www.gbns.rs/" target="_blank" rel="noopener noreferrer" className="hover:underline text-sm" style={{ color: 'var(--accent)' }}>
                {t('officialLinks.library')}
              </a>
            </div>
          </div>
