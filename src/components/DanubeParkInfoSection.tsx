...
export default function DanubeParkInfoSection() {
  const t = useTranslations('danubePark.knowledge');
  const messages = useMessages() as any;
  const sections = (messages?.danubePark?.knowledge?.sections || []) as Array<{ id: string; title: string; content: string }>;
